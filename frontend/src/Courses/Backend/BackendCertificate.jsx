...
const BackendCertificate = ({
 ...
 useEffect(() => {
  ...
  return (
    <div className="flex mt-15 flex-col items-center justify-center py-10 px-4 bg-gradient-to-tr from-gray-100 to-gray-300 min-h-screen">
      {/* Download Button */}
      ...
      >
        {/* Watermark or Background Logo (Optional) */}
        <img
          src="/SpeaQ.png"
          alt="Logo"
       ...
       <button
        ...
        className="mb-6 mt-10 px-6 py-3 bg-blue-700 text-white text-lg rounded-full shadow-lg hover:bg-blue-800 transition duration-300"
      >
